...
var OneBook3D = {
	...
	initWithData:function(FRDATA){
		...
		this.LNG = {
			...
			hlpUseMousewheelGL:[['Usa la rueda del ratón','para verlo más fácil'],['Используйте колесо','мыши для листания']],
			askSaveImage:['Select the page to save, please','Какое изображение сохранить?'],
			askSaveLinks:['<a href="#">Izquierda</a> or <a href="#">Derecha</a>','<a href="#">Левое</a> или <a href="#">Правое</a>']
		};
