...
( function( document ) {
    ...
    document.addEventListener( "impress:init", function( event ) {
        ...
        util.triggerEvent( document, "impress:help:add",
            { command: "F5 / ESC", text: "Pantalla completa: Entrar / Salir", row: 200 } );
...
( function( document, window ) {
    ...
    document.addEventListener( 'impress:init', function( event ) {
        ...
        triggerEvent( document, 'impress:help:add',
                        { command: 'P', text: 'Consola de presentación', row: 10 } );
    } );
...
( function( document ) {
    ...
    document.addEventListener( "impress:init", function( event ) {
        ...
        util.triggerEvent( document, "impress:help:add", { command: "Izquierda &amp; Derecha",
                                                           text: "Anterior &amp; siguiente",
                                                           row: 1 } );
